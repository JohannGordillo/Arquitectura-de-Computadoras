...
\item La medida de tiempo de rendimiento.\\\\
...
\begin{table}[h]
    \begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|}
        ...
        Prueba & D & B & C & A\\
        \hline
        REDIS LPOP & 2.86 & 0.63 & 4.48 & 1\\   
        \hline       
        REDIS SADD & 2.66 & 0.55 & 4.82 & 1\\   
        \hline 
        REDIS LPUSH & 4.70 & 1.77 & 8.27 & 1\\   
        \hline          
        REDIS GET & 2.83 & 2.08 & 4.98 & 1\\   
        \hline         
        REDIS SET & 2.50 & 2.25 & 5.51 & 1\\   
        \hline                                    
    \end{tabular}
    \caption*{Resultados de las Pruebas de Rendimiento normalizados tomando como referencia a la computadora A}
\end{table}

\noindent Usando la media geométrica, obténemos:
...
\begin{table}[h]
    \begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{4.5cm}|>{\centering\arraybackslash}p{4.5cm}|>{\centering\arraybackslash}p{4.5cm}|}
        ...
        \hline                                
    \end{tabular}
    \caption*{Comparación Final del Rendimiento de las computadoras}
\end{table}

\noindent Cabe recordar que, cuando hablamos de Rendimiento, High Is Better. Por lo que la computadora con el mejor desempeño en las pruebas de Rendimiento fue la computadora C; y la computadora con el peor desempeño fue la computadora A.
\clearpage
...
\begin{table}[h]
    \begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{3.26cm}|}
        ...
        \hline                                             
    \end{tabular}
    \caption*{Resultados de las Pruebas de Tiempo de Respuesta normalizados tomando como referencia a la computadora A}
\end{table}
\clearpage
...
\begin{table}[h]
    \begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{4.5cm}|>{\centering\arraybackslash}p{4.5cm}|>{\centering\arraybackslash}p{4.5cm}|}
        ...
        \hline                                
    \end{tabular}
    \caption*{Comparación Final del Tiempo de Respuesta de las computadoras}
\end{table}

\noindent Cabe recordar que, cuando hablamos de tiempo de respuesta, Low Is Better. Por lo que la computadora con el mejor desempeño en las pruebas de Tiempo de Respuesta fue la computadora D; y la computadora con el peor desempeño fue la computadora B.
\clearpage
...
\noindent La computadora con el mejor tiempo de ejecución es la computadora D y la computadora con la peor medida de tiempo de ejecución es la computadora B.\\\\
\noindent \textbf{El tiempo de ejecución de la computadora D es 13.4 veces mejor que el de la computadora B.}\\\\
\noindent El factor fue calculado mediante $\frac{B}{D}$ pues estamos hablando de medida de tiempo de ejecución y Low Is Better.\\\\
...
\noindent La computadora con el mejor rendimiento es la computadora C y la computadora con el peor desempeño es la computadora A.\\\\
\noindent \textbf{El rendimiento de la computadora C es 5.47 veces mejor que la computadora A.}\\\\
\noindent El factor fue calculado mediante $\frac{C}{A}$ pues estamos hablando de medida de rendimiento y High Is Better.\\\\
